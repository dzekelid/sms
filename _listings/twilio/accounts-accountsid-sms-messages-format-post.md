  ...
  /Accounts/{AccountSid}/SMS/Messages.{format}:
    post:
      ...
      responses:
        ...
        201:
          description: The request was successful, we created a new resource and the
        ...
        400:
          description: The data given in the POST or PUT failed validation
          schema:
            type: array
            items:
              $ref: '#/definitions/Exception'
        401:
          description: The supplied credentials, if any, are not sufficient to create
        ...
        429:
          ...
          schema:
            ...
            items:
              $ref: '#/definitions/Exception'
        500:
          description: We couldn't create or update the resource
          schema:
            type: array
            items:
              $ref: '#/definitions/Exception'
